...
![yellow-main](https://raw.githubusercontent.com/akud/yellow/akud/readme/packages/client/yellow-main.png)
...
![sample-architecture-diagram](https://raw.githubusercontent.com/akud/yellow/akud/readme/packages/client/sample-architecture-diagram.png)
...
[Elements](https://github.com/akud/yellow/tree/akud/readme/packages/client/src/elements), [Simulations](https://github.com/akud/yellow/tree/akud/readme/packages/client/src/simulation), and [Graphs](https://github.com/akud/yellow/tree/akud/readme/packages/client/src/graphs). Each of these is an importable name from `@akud/yellow-client`, and all components can be imported directly.


## <a name="elements">Elements</a>

![basic_elements](https://raw.githubusercontent.com/akud/yellow/akud/readme/packages/client/basic_elements.png)
...
* <a name="arrow" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Arrow.js">`Arrow`</a> - renders an arrow pointing at the desired position
...
* <a name="circle" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Circle.js">`Circle`</a> - renders a circle centered at the given position
...
* <a name="curve" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Curve.js">`Curve`</a> - renders a curve between the given points
...
* <a name="display-window" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/DisplayWindow.js">`DisplayWindow`</a> - top-level wrapper component for holding elements. Renders `children` inside an svg with the provided size.
...
* <a name="element-group" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/ElementGroup.js">`ElementGroup`</a> - renders `children` inside a `<g>` tag. Forwards all props to the `<g>` tag.

* <a name='element-prop-types-link' href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/ElementPropTypes.js">ElementPropTypes.link</a> - Defines a link prop type for linking to a web page
...
* <a name='element-prop-types-position'
  href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/ElementPropTypes.js">ElementPropTypes.position</a>
...
* <a name='element-prop-types-curvature' href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/ElementPropTypes.js">ElementPropTypes.curvature</a> - Determines the curvature of a line or edge, from a max concavity
...
* <a name="html-fragment" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/HtmlFragment.js">`HtmlFragment`</a> - renders `children` inside an html fragment centered at the given position
...
* <a name="image" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Image.js">`Image`</a> - renders an image
...
* <a name="label" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Label.js">`Label`</a> - renders svg text centered at the given position
...
* <a name="line" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Line.js">`Line`</a> - renders a line between the given points
...
* <a name="link" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Link.js">`Link`</a> - renders `children` in an `<a>` tag to link to a web page.
...
* <a name="rectangle" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/Rectangle.js">`Rectangle`</a> - renders a rectangle centered at the given position
...
* <a name="window-context" href="https://github.com/akud/yellow/blob/akud/readme/packages/client/src/elements/WindowContext.js">`WindowContext`</a> - [Context](https://reactjs.org/docs/context.html) that provides basic information about the window. Will be provided by [DisplayWindow](#display-window)
...
![simulations](https://raw.githubusercontent.com/akud/yellow/akud/readme/packages/client/simulation.gif)
...
[d3 force simulation](https://github.com/d3/d3/blob/akud/readme/API.md#forces-d3-force)
...
* <a name='orientation' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Orientation.js'>Orientation</a> - enumeration of orientations available in a simulation.
...
* <a name='rules' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>Rules</a> - module containing embeddable `Rule` components to
...
component is also accessible as a top level property of `Simulations`.
  ...
  * <a name='directional-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>DirectionalRule</a> - Rule that pushes elements in a direction
  ...
  * <a name='positioning-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>PositioningRule</a> - Rule that pushes elements towards a position
  ...
  * <a name='centering-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>CenteringRule</a> - Rule that pushes elements towards the window center
  ...
  * <a name='orienting-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>OrientingRule</a> - Rule that orients a group of elements relative to a base element
  ...
  * <a name='linking-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>LinkingRule</a> - Rule that links two elements together, acting on them both to keep them a desired distance apart.
  ...
  * <a name='binding-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>BindingRule</a> - Rule that binds a set of target elements to a base element, acting only on the target elements to keep them a desired distance away from the base element.
  ...
  * <a name='function-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>FunctionRule</a> - Rule that runs a function to determine forces to apply at each simulation iteration

    Props:

    * `rule`: PropTypes.func.isRequired - function with signature
      ([simulation](https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/force/ForceSimulation.js)) =&gt; [[ForceApplication]((https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/force/ForceApplication.js), ...] that will be passed the simulation object (for retrieving current element data) and should return an array of ForceApplication objects determining forces to apply in the next iteration of the simulation

  * <a name='repelling-rule' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/Rules.js'>RepellingRule</a> - Sets the simulation-wide repelling force strength
...
* <a name='simulated-element' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/simulated-element.js'>SimulatedElement</a> Wraps a single [Element](#elements) and positions it based on the current [SimulationContext](#simulation-context)
...
* <a name='simulated-link' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/SimulatedLink.js'>SimulatedLink</a> - links two elements in the simulation together and passes their positions to a render prop. This is used to render edges between nodes in a graph
...
* <a name='simulation-prop-types-element-selector' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/simulation/SimulationPropTypes.js'>SimulationPropTypes.elementSelector</a> - determines a set of elements for rules to apply to.
...
* <a name='circlenode' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/graphs/CircleNode.js'>CircleNode</a> - Convenience component to render a [Circle](#circle) inside a [Node](#node).
...
* <a name='edge' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/graphs/Edge.js'>Edge</a> - Renders an edge in the graph
...
* <a name='graph' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/graphs/Graph.js'>Graph</a> - Main entrypoint for rendering graphs. This renders a graph inside a [SimulationWindow](#simulation-window) which is used to determine the layout
...
* <a name='htmlnode' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/graphs/HtmlNode.js'>HtmlNode</a> - renders children inside an [HtmlFragment](#html-fragment) inside a (Node)[#node]
...
* <a name='imagenode' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/graphs/ImageNode.js'>ImageNode</a> - renders an [Image](#image) inside a [Node]
 ...
 * <a name='pointnode' href='https://github.com/akud/yellow/blob/akud/readme/packages/client/src/graphs/PointNode.js'>PointNode</a> - Renders a point-sized, invisible node
